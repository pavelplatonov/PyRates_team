...
2. Ввести в git bash команду:
  - если SSH настроен `git clone git@github.com:pavelplatonov/PyRates_team.git`
  - если SSH не настроен `git clone https://github.com/pavelplatonov/PyRates_team.git`
